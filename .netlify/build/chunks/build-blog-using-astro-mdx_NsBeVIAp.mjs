    ...
    children: [createVNode(Callout, {
      ...
      children: createVNode(_components.p, {
        children: ["The text below is from the ", createVNode(_components.a, {
          ...
          children: "Tailwind\nCSS"
        }), " docs. I copied it\nhere to test the markdown styles. ", createVNode(_components.strong, {
...
const url = "src/content/guides/build-blog-using-astro-mdx.mdx";
const file = "E:/WEB-DEV/astro-nomy-master/src/content/guides/build-blog-using-astro-mdx.mdx";
...
Content.moduleId = "E:/WEB-DEV/astro-nomy-master/src/content/guides/build-blog-using-astro-mdx.mdx";
