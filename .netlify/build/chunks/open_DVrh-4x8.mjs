import { a as createComponent, r as renderTemplate, e as renderComponent, m as maybeRenderHead, b as addAttribute } from './astro/server_BNGISfs7.mjs';
import 'kleur/colors';
import { $ as $$MainLayout, a as $$Icon } from './main-layout_CdOdj119.mjs';
...
Check <a href="/newsletter" class="underline" data-astro-cid-sejuczmy>here</a> for a form with
            counter.
</p> </div> ${renderComponent($$result3, "WaitlistForm", WaitlistForm, { "client:load": true, "client:component-hydration": "load", "client:component-path": "@/components/forms/waitlist-form", "client:component-export": "WaitlistForm", "data-astro-cid-sejuczmy": true })} </div> </div> </div> </div> ` })} ` })}`;
